...
import {
  ...
  Car, Calendar, ChevronRight, CheckCircle, Clock, XCircle,
} from "lucide-react";
...
const contracts = [
  { id: "CS-2026-0142", vehicle: "Dacia Logan 2023", type: "Tous Risques", status: "Actif", expiry: "15/09/2026", premium: "2 800 DH" },
  { id: "CS-2026-0087", vehicle: "Renault Clio 2021", type: "Tiers", status: "Actif", expiry: "03/12/2026", premium: "1 200 DH" },
];

const notifications = [
  { text: "Échéance de paiement dans 5 jours", type: "warning" as const, time: "Il y a 2h" },
  { text: "Sinistre #SN-2026-034 en cours de traitement", type: "info" as const, time: "Il y a 1j" },
  { text: "Nouvelle offre Confort Plus disponible", type: "success" as const, time: "Il y a 3j" },
];
  ...
  return (
    <div className="space-y-6">
      ...
      <motion.div initial="hidden" animate="visible" variants={fadeUp} custom={0} className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
          <h2 className="font-display text-2xl font-bold text-foreground">Bonjour, Ahmed 👋</h2>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        {[
          ...
          { label: "Sinistres en cours", value: "1", icon: AlertTriangle, color: "text-warning" },
          { label: "Prochaine échéance", value: "5 jours", icon: Calendar, color: "text-destructive" },
          { label: "Total payé (2026)", value: "4 000 DH", icon: CreditCard, color: "text-success" },
        ].map((stat, i) => (
